...
<style>
    ...
    z-index: 9999;
    display: none; /* الافتراضي أن يكون غير ظاهر */
    justify-content: center;
    align-items: center;
}
      ...
      <div class="form-container">
        ...
        <div id="company-form" class="form-section active">
          ...
          <form action="../fun/add_company.php" method="POST" onsubmit="handleFormSubmit()">
            ...
            <div class="mb-3">
              <input type="text" name="Specialization" class="form-control" placeholder="Specialization"require>
            </div>
            <div class="mb-3">
              <input type="password" name="Password" class="form-control" placeholder="Password" require>
            </div>
            <div class="mb-3">
              <input type="text" name="Phone" class="form-control" placeholder="Phone" require>
            </div>
            ...
            <div class="text-center mt-3">
                <a href="login.php" class="text-decoration-none">Do you have account? login</a>
            </div>
          </form>
        </div>
        ...
        <div id="student-form" class="form-section">
          ...
          <form action="../fun/add_std.php" method="POST" enctype="multipart/form-data" onsubmit="handleFormSubmit()">
            <div class="mb-3">
            ...
            <div class="mb-3">
              <input type="date" name="Birthdate" class="form-control" placeholder="Birthdate" require>
            </div>
            <div class="mb-3">
              <input type="text" name="Academic" class="form-control" placeholder="Academic Level" require>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="uploadFile" name="uploadedFile" accept=".jpg,.jpeg,.png,.pdf"require>
                    <small class="form-text text-muted">Allowed formats: JPG, PNG, PDF</small>
                    </div>
