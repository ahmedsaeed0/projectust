        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1"></span>MAYAQUMAH</h1>
                </a>
            </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <form action="fun/logintest.php" method="get">
                <input type="" name="n1" placeholder="username">
                ...
                <div class="input-group-append">
                    <button class="btn btn-primary px-4">login</button><br>
